...
Function Set-HostnameMapping {
    ...
    If ($Address.Matches) {
        ...
        Else {
            Start-Process -FilePath (Get-Process -Id $PID).Path -Verb RunAs -ArgumentList "-Command Set-HostnameMapping -Hostname $Hostname -NewHostname $NewHostname -NewIPAddress $NewIPAddress"
        }
    }
}
